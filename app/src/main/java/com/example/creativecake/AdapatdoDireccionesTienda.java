...
public class AdapatdoDireccionesTienda extends RecyclerView.Adapter<AdapatdoDireccionesTienda.pedidoViewHolder>{
    ...
    public AdapatdoDireccionesTienda(ArrayList<String> nom_user, ArrayList<String> dir_user, Context context){
    ...
    public pedidoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View vista= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapatador_dir_tienda,parent,false);
