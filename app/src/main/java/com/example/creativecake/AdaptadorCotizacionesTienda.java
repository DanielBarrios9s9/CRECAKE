...
public class AdaptadorCotizacionesTienda extends RecyclerView.Adapter<AdaptadorCotizacionesTienda.CotizacionviewHolder>{
    ArrayList<CotizacionHelperClass> listaProductos;
    Context globalContext;
    String telefono;

    public AdaptadorCotizacionesTienda(ArrayList<CotizacionHelperClass> listaProductos, Context globalContext, String telefono) {
    ...
    public void onBindViewHolder(@NonNull CotizacionviewHolder holder, int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dialog_detalles dialog_product = new Dialog_detalles(producto, SharedPreferences_Util.getPhone_SP(globalContext), globalContext);
            }
        });
